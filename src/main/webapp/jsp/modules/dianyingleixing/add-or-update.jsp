					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>电影类型管理</span></li>
								<li class="breadcrumb-item active"><span>编辑电影类型</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>电影类型</label>
										<input name="dianyingleixing" id="dianyingleixing" name="dianyingleixing" class="form-control" placeholder="电影类型">
									</div>
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.dianyingleixing != null && res.data.dianyingleixing != ''){
						...
						$("#dianyingleixing").attr('readonly','readonly');
					}
				}
			});  
            }
