...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>影院信息管理</span></li>
								<li class="breadcrumb-item active"><span>影院信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yingyuandizhiSearch" class="form-control form-control-sm" placeholder="请输入影院地址" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			...
			if($('#yingyuandizhiSearch').val() != null && $('#yingyuandizhiSearch').val() != ''){
				searchForm.yingyuandizhi ="%" +  $('#yingyuandizhiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("yingyuanxinxi/page","GET",{
				...
				yingyuandizhi : searchForm.yingyuandizhi,	
			},(res)=>{
				if(res.code == 0){
					clear();
