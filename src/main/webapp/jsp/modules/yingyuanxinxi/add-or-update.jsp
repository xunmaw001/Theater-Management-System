					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑影院信息</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>影院名称</label>
										<input name="yingyuanmingcheng" id="yingyuanmingcheng" name="yingyuanmingcheng" class="form-control" placeholder="影院名称">
									</div>
									<div class="form-group col-md-6">
										<label>影院地址</label>
										<input name="yingyuandizhi" id="yingyuandizhi" name="yingyuandizhi" class="form-control" placeholder="影院地址">
									</div>
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yingyuanmingcheng != null && res.data.yingyuanmingcheng != ''){
						...
						$("#yingyuanmingcheng").attr('readonly','readonly');
					}
