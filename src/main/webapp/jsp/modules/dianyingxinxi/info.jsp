...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<img id="dianyingfengmianImg" src="" width="100" height="100">
									</div>
									...
									<input id="faxingshang" name="faxingshang" class="form-control" v-model="ruleForm.faxingshang" readonly>
									</div>

									<div class="form-group col-md-6">
									<label>电影内容</label>

									<button class="btn-upload" id="dianyingneirong">点击播放</button>
									</div>
									<div class="form-group col-md-6">
									<label>影院名称</label>
									...
									<input id="yingyuandizhi" name="yingyuandizhi" class="form-control" v-model="ruleForm.yingyuandizhi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>上映日期</label>
									...
									<div class="form-group  col-md-12">
										<label>演员</label>
										<script id="yanyuanEditor" type="text/plain" style="width:800px;height:230px;"></script>
										<script type="text/javascript">
										    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
										   //相见文档配置属于你自己的编译器
										 var yanyuanUe = UE.getEditor('yanyuanEditor', {
											toolbars: [
													[
														'undo', //撤销
														'bold', //加粗
										...
										<input type="hidden" name="yanyuan" id="yanyuan-input">
									</div>
									<div class="form-group  col-md-12">
										<label>电影简介</label>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
			if(ruleForm.yanyuan != null && ruleForm.yanyuan != 'null' && ruleForm.yanyuan != ''){
				var mes = '' + ruleForm.yanyuan;
				var yanyuanUeditor = UE.getEditor('yanyuanEditor');
				yanyuanUeditor.ready(function() {
					yanyuanUeditor.setContent(mes);
					yanyuanUeditor.setDisabled('fullscreen');
				});
			}
		...
		function setMediaUrl(){
			var dianyingneirongAttr = "mediaPlay('" + ruleForm.dianyingneirong + "')";
			$("#dianyingneirong").attr("onclick",dianyingneirongAttr);
		}	
		//打开新窗口播放媒体
