...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yingyuanmingchengSearch" class="form-control form-control-sm" placeholder="请输入影院名称" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('faxingshang')">发行商<i id="faxingshangIcon" class="fa fa-sort"></i></th>
											<th>电影简介</th>
											<th>电影内容</th>
											<th onclick="sort('yingyuanmingcheng')">影院名称<i id="yingyuanmingchengIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('yingyuandizhi')">影院地址<i id="yingyuandizhiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var dianyingfengmianCell  = document.createElement('td');

				                var dianyingfengmianImg = document.createElement('img');
			dianyingfengmianImg.setAttribute('src',baseUrl+item.dianyingfengmian);
			dianyingfengmianImg.setAttribute('height',100);
			dianyingfengmianImg.setAttribute('width',100);
			dianyingfengmianCell.appendChild(dianyingfengmianImg);


			row.appendChild(dianyingfengmianCell);
			var yanyuanCell  = document.createElement('td');

						  if(item.yanyuan != null && item.yanyuan != "" && item.yanyuan.length >= 11){
			  	yanyuanCell.innerHTML = item.yanyuan.substring(0, 10) + "..."; 
			  }else{
			...
			var faxingshangCell  = document.createElement('td');

						 faxingshangCell.innerHTML = item.faxingshang;

			row.appendChild(faxingshangCell);
			...
			var dianyingneirongCell  = document.createElement('td');

						  var dianyingneirongMedia = document.createElement('button');
			  dianyingneirongMedia.setAttribute('class','btn-table')
			  dianyingneirongMedia.innerHTML = '播放';
			  var dianyingneirongAttr = "mediaPlay('" + baseUrl+ item.dianyingneirong + "')"
			  dianyingneirongMedia.setAttribute('onclick',dianyingneirongAttr);
       		          dianyingneirongCell.appendChild(dianyingneirongMedia);


			row.appendChild(dianyingneirongCell);
			...
			var yingyuandizhiCell  = document.createElement('td');

						 yingyuandizhiCell.innerHTML = item.yingyuandizhi;

			row.appendChild(yingyuandizhiCell);
