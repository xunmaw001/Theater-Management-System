					    ...
					    <div class="list-4-body">
					    			<div v-if="dianyingxinxiRecommend.length>0" @click="jump('../dianyingxinxi/detail.jsp?id='+dianyingxinxiRecommend[0].id)" class="list-4-item animation-box item-2" :style='{"padding":"0","boxShadow":"10px 0 0px #D0A5D8","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"900px 900px 90px 90px","borderWidth":"0","width":"290px","borderStyle":"solid","height":"200px"}'>
					    			  ...
					    			  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(85, 27, 124, 0.5)","borderRadius":"0 0 18px 18px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{dianyingxinxiRecommend[0].dianyingmingcheng}}</div>
					    			  </div>
					    			</div>
					    			<div v-if="dianyingxinxiRecommend.length>1" @click="jump('../dianyingxinxi/detail.jsp?id='+dianyingxinxiRecommend[1].id)" class="list-4-item animation-box item-3" :style='{"padding":"0","boxShadow":"10px 0 0px #D0A5D8","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"900px 900px 90px 90px","borderWidth":"0","width":"290px","borderStyle":"solid","height":"200px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(85, 27, 124, 1)","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"900px 900px 90px 90px","borderWidth":"5px","width":"100%","borderStyle":"solid","height":"100%"}' :src="dianyingxinxiRecommend[1].dianyingfengmian?baseurl+dianyingxinxiRecommend[1].dianyingfengmian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(85, 27, 124, 0.5)","borderRadius":"0 0 18px 18px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{dianyingxinxiRecommend[1].dianyingmingcheng}}</div>
					    			  </div>
					    			</div>
					    </div>
						<div v-if="dianyingxinxiRecommend.length>2" class="list-4-item animation-box item-1" @click="jump('../dianyingxinxi/detail.jsp?id='+dianyingxinxiRecommend[2].id)" :style='{"padding":"0","boxShadow":"10px 0 0px #D0A5D8","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"900px 900px 90px 90px","borderWidth":"0","width":"310px","borderStyle":"solid","height":"420px"}'>
									<img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(85, 27, 124, 1)","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"900px 900px 90px 90px","borderWidth":"5px","width":"100%","borderStyle":"solid","height":"100%"}' :src="dianyingxinxiRecommend[2].dianyingfengmian?baseurl+dianyingxinxiRecommend[2].dianyingfengmian.split(',')[0]:''" alt="" />
									<div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(85, 27, 124, 0.5)","borderRadius":"0 0 18px 18px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
										<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{dianyingxinxiRecommend[2].dianyingmingcheng}}</div>
									</div>
						</div>
					    <div class="list-4-body">
					    			<div v-if="dianyingxinxiRecommend.length>3" @click="jump('../dianyingxinxi/detail.jsp?id='+dianyingxinxiRecommend[3].id)" class="list-4-item animation-box item-4" :style='{"padding":"0","boxShadow":"10px 0 0px #D0A5D8","margin":"0 0 20px 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"900px 900px 90px 90px","borderWidth":"0","width":"290px","borderStyle":"solid","height":"200px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(85, 27, 124, 1)","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"900px 900px 90px 90px","borderWidth":"5px","width":"100%","borderStyle":"solid","height":"100%"}' :src="dianyingxinxiRecommend[3].dianyingfengmian?baseurl+dianyingxinxiRecommend[3].dianyingfengmian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(85, 27, 124, 0.5)","borderRadius":"0 0 18px 18px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{dianyingxinxiRecommend[3].dianyingmingcheng}}</div>
							  </div>
					    			</div>
					    			<div v-if="dianyingxinxiRecommend.length>4" @click="jump('../dianyingxinxi/detail.jsp?id='+dianyingxinxiRecommend[4].id)" class="list-4-item animation-box item-5" :style='{"padding":"0","boxShadow":"10px 0 0px #D0A5D8","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"900px 900px 90px 90px","borderWidth":"0","width":"290px","borderStyle":"solid","height":"200px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(85, 27, 124, 1)","backgroundColor":"rgba(204, 204, 204, 0)","borderRadius":"900px 900px 90px 90px","borderWidth":"5px","width":"100%","borderStyle":"solid","height":"100%"}' :src="dianyingxinxiRecommend[4].dianyingfengmian?baseurl+dianyingxinxiRecommend[4].dianyingfengmian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(85, 27, 124, 0.5)","borderRadius":"0 0 18px 18px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,0)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{dianyingxinxiRecommend[4].dianyingmingcheng}}</div>
					    			  </div>
					    			</div>
					    </div>
					</div>
				...
				<div class="recommend index-pv3" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 6px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent url(http://codegen.caihongy.cn/20220304/9241406660ef488a8ecc66585e5d1f12.png) no-repeat top","borderStyle":"solid"}'>
					<div class="box" style='width:70%'>
						...
						<div class="title" :style='{"isshow":true,"padding":"10px 0 10px 0","boxShadow":"0 00px rgba(110,22,64,.8)","margin":"-90px 600px 50px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"18px","borderStyle":"solid"}'>
							<span>DATA SHOW</span><span>电影信息展示</span>
						</div>
						...
						<div id="lists-five-swiperdianyingxinxi" class="swiper-container lists-five-swiper" style="box-sizing: border-box;" :style='{"padding":"50px 0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"600px"}'>
						  <div class="swiper-wrapper">
						    <div class="swiper-slide" v-for="(item,index) in dianyingxinxiList" class="list-item" :key="index" @click="jump('../dianyingxinxi/detail.jsp?id='+item.id)">
								<img style="object-fit: cover;position:absolute;" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"30px","borderWidth":"0","width":"200px","borderStyle":"solid","height":"325px"}' :src="item.dianyingfengmian?baseurl+item.dianyingfengmian.split(',')[0]:''" alt="" />
							</div>
						  </div>
						  <!-- Add Pagination -->
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
                ...
                http.request(`dianyingxinxi/list`, 'get', {
					...
					vue.dianyingxinxiList = res.data.list
					let flag = 5;
					let options = {"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"slidesPerView":5,"loop":true,"spaceBetween":20,"autoplay":{"delay":3000,"disableOnInteraction":false}}
					options.pagination = {el:'null'}
					if(options.slidesPerView) {
					...
					if(flag == 3) {
						vue.$nextTick(() => {
							new Swiper ('#listsdianyingxinxi', options)
						})
					}
					// 商品列表样式五
					if(flag == 5) {
						vue.$nextTick(() => {
							var swiper = new Swiper('#lists-five-swiperdianyingxinxi', {
								loop: true,
								speed: 500,
								slidesPerView: Number(5),
								spaceBetween: Number(10),
